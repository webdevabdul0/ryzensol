...
const Contact = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        setSuccess(true);
        setForm({ name: "", email: "", service: SERVICE_OPTIONS[0], details: "" });
      } else {
        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between max-w-[1440px] z-30 px-8 2xl:px-0">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 lg:mb-0">
              ...
              <div className="mb-8 flex flex-col gap-4 w-full max-w-[370px]">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
            <div className="relative rounded-lg bg-white bg-opacity-5 backdrop-blur-2xl p-8 shadow-lg dark:bg-dark-2 sm:p-12">
              <form onSubmit={handleSubmit}>
                ...
                {success && <div className="text-green-400 mb-4">Thank you! Your message has been sent.</div>}
                <div>
                  <button
                    type="submit"
...
const ContactEmailBox = ({ email }: { email: string }) => (
  <div className="flex items-center gap-3 bg-white/10 rounded-xl px-4 py-6">
    <svg width="20" height="20" fill="none" viewBox="0 0 24 24" className="text-primary"><path d="M2 6.5A2.5 2.5 0 0 1 4.5 4h15A2.5 2.5 0 0 1 22 6.5v11a2.5 2.5 0 0 1-2.5 2.5h-15A2.5 2.5 0 0 1 2 17.5v-11Zm2.5-.5a.5.5 0 0 0-.5.5v.217l8 5.333 8-5.333V6.5a.5.5 0 0 0-.5-.5h-15Zm15 13a.5.5 0 0 0 .5-.5v-8.383l-7.5 5-7.5-5V17.5a.5.5 0 0 0 .5.5h15Z" fill="currentColor"/></svg>
    <span className="text-base text-body-color dark:text-dark-6">{email}</span>
  </div>
);
...
const ContactSelectBox = ({ name, value, onChange, options }: { name: string, value: string, onChange: (e: React.ChangeEvent<HTMLSelectElement>) => void, options: string[] }) => (
  <div className="mb-6 relative">
    <select
      ...
      value={value}
      onChange={onChange}
      className="w-full rounded-2xl border border-white/20 bg-black/90 text-white placeholder-white/80 backdrop-blur-3xl border-stroke px-4 py-3 pr-10 text-base outline-none focus:border-primary focus:ring-2 focus:ring-primary transition-colors duration-200 appearance-none shadow-lg"
      required
    >
      {options.map((opt) => (
