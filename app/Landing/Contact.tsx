              ...
              <div className="relative rounded-lg bg-white bg-opacity-5 backdrop-blur-2xl p-8 shadow-lg dark:bg-dark-2 sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      className="w-full rounded-full border border-primary bg-primary p-3 text-white transition hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
    ...
    <>
      <div className="mb-6">
        <input
          ...
          placeholder={placeholder}
          name={name}
          className="w-full rounded-2xl border bg-white/5 border-white/20 backdrop-blur-3xl border-stroke px-[14px] py-3 text-base text-body-color outline-none focus:border-primary "
        />
      </div>
    </>
  );
